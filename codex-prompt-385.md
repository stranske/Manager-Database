...
**Progress:** 4/8 tasks complete, 4 remaining
...
- [x] Add endpoint to get all managers
- [x] Add endpoint to get manager by ID
- [x] Support pagination for list endpoint
- [x] Add response models for manager endpoints in `models.py` with fields for ID, name, and role.

### Acceptance Criteria
The PR is complete when ALL of these are satisfied:

- [x] GET /managers returns paginated list
- [x] GET /managers/{id} returns single manager or 404
- [x] Pagination supports limit and offset
...
Source: https://github.com/stranske/Manager-Database/issues/384
