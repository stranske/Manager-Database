...
- [x] The '.github/scripts/github-rate-limited-wrapper.js' file contains no changes unrelated to the memory profiler.
- [x] The '_run_profiler_loop()' function allows 'asyncio.CancelledError' to propagate without being caught.
- [x] The 'start_background_profiler()' function raises a 'ValueError' for non-positive 'interval_s' values.
- [x] Unit tests confirm that valid positive 'interval_s' values set the delay between snapshots correctly.
- [x] Documentation in 'docs/memory_profiler.md' is updated to reflect the storage of 'interval_s' in 'app.state.memory_profiler_interval_s'.
