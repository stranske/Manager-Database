...
```markdown
## Why
PR #350 addressed issue #349 but verification identified concerns (verdict: **CONCERNS**). This follow-up addresses the remaining gaps with improved task structure to ensure deterministic and reliable test outcomes.
...
- [x] [#350](https://github.com/stranske/Manager-Database/issues/350)
- [x] [#349](https://github.com/stranske/Manager-Database/issues/349)

### Acceptance Criteria
The PR is complete when ALL of these are satisfied:

- [x] Update the /health endpoint test to use a fully injected, deterministic mocked clock/timer driver.
- [x] Refactor retry logic tests to inject a mock for the sleep/delay function and assert the correct backoff sequence.
- [x] Implement new tests for the circuit breaker to simulate failure and cooldown using a mocked timer.
- [x] Enhance health alerts validator tests by semantically parsing the monitoring/alerts/health-checks.yml file.

### Recently Attempted Tasks
Avoid repeating these unless a task needs explicit follow-up:

- [#349](https://github.com/stranske/Manager-Database/issues/349)
- [#350](https://github.com/stranske/Manager-Database/issues/350)
